package io.provenance.classification.asset.client.provenance
...
/**
 * A Provenance Signer implementation to assist in providing methods of executing the [ACClient][io.provenance.classification.asset.client.client.base.ACClient]'s various requests.
 * This helper provides multiple ways to derive the signer and eventually boils down to using the public and private
 * keys to sign requests.
 */
class AccountSigner(
